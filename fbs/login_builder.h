#ifndef LOGIN_BUILDER_H
#define LOGIN_BUILDER_H
...
__flatbuffers_build_table(flatbuffers_, response, 3)
static const flatbuffers_voffset_t __Protocol_required[] = {0 };
__flatbuffers_build_table(flatbuffers_, Protocol, 2)
#define __request_formal_args , flatbuffers_string_ref_t v0, flatbuffers_string_ref_t v1
#define __request_call_args , v0, v1
static inline request_ref_t request_create(flatbuffers_builder_t *B __request_formal_args);
#define __response_formal_args , int32_t v0, flatbuffers_string_ref_t v1, flatbuffers_string_ref_t v2
#define __response_call_args , v0, v1, v2
...
__flatbuffers_build_string_field(0, flatbuffers_, request_nick_name)
__flatbuffers_build_string_field(1, flatbuffers_, request_password)

static inline request_ref_t request_create(flatbuffers_builder_t *B __request_formal_args)
{
    if (request_start(B)
        || request_nick_name_add(B, v0)
        || request_password_add(B, v1)) {
        return 0;
    }
...
__flatbuffers_build_string_field(1, flatbuffers_, response_player_id)
__flatbuffers_build_string_field(2, flatbuffers_, response_session)

static inline response_ref_t response_create(flatbuffers_builder_t *B __response_formal_args)
{
    if (response_start(B)
        || response_retcode_add(B, v0)
        || response_player_id_add(B, v1)
        || response_session_add(B, v2)) {
        return 0;
    }
